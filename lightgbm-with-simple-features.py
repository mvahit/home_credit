...
# pycharm
# virtual envs
# Decorator fonksiyonlar. Arguman olarak fonksiyon alan ve aldıkları fonksiyonu modifiye eden fonksiyonlardır.
# context manager ne demek?
# Command line interfaces (CLIs): argparse


# debug modunu consoldan acip kapatmak icin
def get_namespace():
